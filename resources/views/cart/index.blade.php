                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="cart_container">
                        ...
                        @csrf
                                            ...
                                            <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                                ...
                                                <div class="cart_item_total cart_info_col">
                                                    <div class="cart_item_text">
                                                        <button type="button" class="btn btn-danger sm test-btn" data-id="{{$item->getId()}}"><i class="fa-solid fa-trash"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <button type="submit" class="button cart_button_checkout" {{!$cart->hasItems() ? 'disabled' : ''}}>Continue to payment</button></div>
                        </div>
                    </form>
                </div>
            </div>
