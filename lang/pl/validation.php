...
return [
    ...
    "ascii" =>
        "Pole :attribute może zawierać tylko jednobajtowe znaki alfanumeryczne i symbole.",
    ...
    "between.array" =>
        "Pole :attribute musi składać się z :min - :max elementów.",
    "between.file" =>
    ...
    "doesnt_end_with" =>
        "Pole :attribute nie może kończyć się jednym z następujących wartości: :values.",
    "doesnt_start_with" =>
        "Pole :attribute nie może zaczynać się od jednego z następujących wartości: :values.",
    ...
    "extensions" =>
        "Pole :attribute musi mieć jedno z następujących rozszerzeń: :values.",
    ...
    "hex_color" =>
        "Pole :attribute musi mieć podany prawidłowy kolor w formacie szesnastkowym.",
    ...
    "missing_unless" =>
        "Musi brakować pola :attribute, chyba że :other to :value.",
    "missing_with" =>
        "Jeśli występuje wartość :values, musi brakować pola :attribute.",
    "missing_with_all" =>
        "Jeśli występuje :values, musi brakować pola :attribute.",
    "multiple_of" => "Pole :attribute musi być wielokrotnością wartości :value",
    "not_in" => "Zaznaczony :attribute jest nieprawidłowy.",
    "not_regex" => "Format pola :attribute jest nieprawidłowy.",
    "numeric" => "Pole :attribute musi być liczbą.",
    "password.letters" =>
        "Pole :attribute musi zawierać przynajmniej jedną literę.",
    "password.mixed" =>
        "Pole :attribute musi zawierać przynajmniej jedną wielką i jedną małą literę.",
    "password.numbers" =>
        "Pole :attribute musi zawierać przynajmniej jedną liczbę.",
    "password.symbols" =>
        "Pole :attribute musi zawierać przynajmniej jeden symbol.",
    "password.uncompromised" =>
        "Podany :attribute pojawił się w wycieku danych. Proszę wybrać inną wartość :attribute.",
    "present" => "Pole :attribute musi być obecne.",
    "present_if" =>
        "Pole :attribute musi być obecne jeżeli :other ma wartość :value.",
    "present_unless" =>
        "Pole :attribute musi być obecne, chyba że :other ma wartość :value.",
    "present_with" =>
        "Pole :attribute musi być obecne kiedy :values jest podany/a..",
    "present_with_all" =>
        "Pole :attribute musi być obecne kiedy :values są podane.",
    ...
    "required_if_accepted" =>
        "To pole jest wymagane gdy :other jest zaakceptowane.",
    "required_unless" =>
